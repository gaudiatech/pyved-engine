...
class MyGame:
    ...
    def launch(self):
        ...
        self.tilemap = pyv.tmx.data.load_tmx('level.tmx')  # -> Tilemap instance
        ...
        if self.tilemap.background:
            ...
            img = pygame.image.load(self.tilemap.background['img_path'])
            tmp_img = pygame.transform.scale(img, scr_size)
        ...
        self.viewport = pyv.tmx.misc.Viewport(self.tilemap, (0,0), scr_size)
        self.first_run = True
    ...
    def _reset_game(self):
        ...
        self.sprites = pyv.tmx.misc.SpriteLayer()
        start_cell = self.tilemap.layers['triggers'].find('player')[0]
        print(start_cell)

        self.player = Player((start_cell.px, start_cell.py), self.sprites)
        self.tilemap.layers.append(self.sprites)
        self.enemies = pyv.tmx.misc.SpriteLayer()
