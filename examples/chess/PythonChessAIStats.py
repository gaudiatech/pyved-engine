...
class PythonChessAIStats:
	...
	def PrintResults(self,writeToFile,outFileName,useExternalSeed,seedFileName):
		...
		print ("  {} win pct = {}".format(self.player[0].GetName(),whiteWinPct))
		print ("  {} average number of turns to win = {}".format(self.player[0].GetName(),whiteAveTurnsToWin))
		print( "  {} win pct = {}".format(self.player[1].GetName(),blackWinPct))
		print( "  {} average number of turns to win = {}".format(self.player[1].GetName(),blackAveTurnsToWin))
		...
		if writeToFile:
			...
			f.write(str("{} win pct = {}".format(self.player[0].GetName(),whiteWinPct))+"\n")
			f.write(str("{} average number of turns to win = {}".format(self.player[0].GetName(),whiteAveTurnsToWin))+"\n")
			f.write(str("{} win pct = {}".format(self.player[1].GetName(),blackWinPct))+"\n")
			f.write(str("{} average number of turns to win = {}".format(self.player[1].GetName(),blackAveTurnsToWin))+"\n")
