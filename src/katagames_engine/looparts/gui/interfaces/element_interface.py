...
class IfaceUIElement(metaclass=ABCMeta):
    ...
    """
    # i prefer to keep it at the root of the module...
    ...
    # @abstractmethod
    # def set_clipping_rect(self, rect: Union[pygame.Rect, None]):
    #     """
    ...
    #
    # @abstractmethod
    # def get_clipping_rect(self) -> Union[pygame.Rect, None]:
    #     """
    ...
    def set_active(self, activate_mode: bool):
        """
        tag the widget as active/inactive, which determines if the widget will
        draw itself and process events or not
        """
